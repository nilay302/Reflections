function init() {
   ...
   //bumpMap is used to create uneven topology with the help of light
...
function getMaterial(type, color) {
	...
	switch (type) {
        //MeshBasicMaterial is not affected by light at all, mostly used to represent source of light
		case 'basic':
			selectedMaterial = new THREE.MeshBasicMaterial(materialOptions);
			break;
        //MeshLambertMaterial is used to represent shiny surfaces
		case 'lambert':
			selectedMaterial = new THREE.MeshLambertMaterial(materialOptions);
			break;
        //best material for metals and to cast shadow
		case 'phong':
			selectedMaterial = new THREE.MeshPhongMaterial(materialOptions);
			break;
        //realistic and used by game engines
		case 'standard':
